...
class IpoptAngle():
    ...
    def solve_init(self, eval_J, eval_dJ):
        ...
        low_var = -90*numpy.ones(nvar,dtype=float)
        up_var = 90*numpy.ones(nvar, dtype=float)
...
if __name__ == "__main__":
    ...
    # points = [Point(0.5,0.5), Point(0.75,0.8)]#, Point(0.3,0.8)]
    init_angles = [numpy.random.randint(-90,90) for i in range(len(points))]
    ...
    optimizer.nlp.num_option("tol", 1e-3)
